...
export const REWARDS = [
  ...
  { id: 'norse',     name: 'Neural Norse',        weight: 8,   color: '#E0479E', text: '#2B0A1E', icon: '🪓', image: '/nft/neural-norse.jpg', maxInReel: 1, desc: 'A crowned Norse warrior, axe in hand.', nft: true, claimable: true },
];
