...
export const REWARDS = [
  ...
  { id: 'mask',      name: 'MEFO (Rare)',         weight: 25,  color: '#6B3FCB', text: '#EEE9FA', icon: '◈', image: '/nft/rare-doll-mask.jpg', maxInReel: 1, desc: 'A rare MEFO. Only a fraction of spinners pull this.', nft: true, claimable: true },
  { id: 'punk',      name: 'MEFO (Punk)',         weight: 15,  color: '#5AC8E8', text: '#0B2733', icon: '✷', image: '/nft/mefo-punk.jpg', maxInReel: 1, desc: 'A MEFOLabs punk with fire in its eyes.', nft: true, claimable: true },
  ...
  { id: 'sharx',     name: 'MEFO (LeSharx)',      weight: 8,   color: '#1D6FA5', text: '#EAF6FF', icon: '🦈', image: '/nft/lesharx.jpg', maxInReel: 1, desc: 'A deep-sea diver MEFO, pipe and all.', nft: true, claimable: true },
  ...
  { id: 'moonstone', name: 'MEFO (Legendary)',    weight: 1,   color: '#FBE8B8', text: '#241A05', icon: '☾', image: '/nft/legendary-moonstone.jpg', maxInReel: 1, desc: 'The rarest MEFO on the reel. Very few holders will ever see one.', nft: true, claimable: true },
];
